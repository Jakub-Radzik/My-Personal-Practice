...
//    PlayerDAO dao;
    ...
    @Autowired
    Player2Repository repo;

    @Override
    public void run(String... args) throws Exception {
        logger.info("Inserting Player: {}", repo.insertPlayer(new Player2("Djokovic", "Serbia", Date.valueOf("1987-05-22"), 81)));
        logger.info("Inserting Player: {}", repo.insertPlayer(new Player2("Monfils", "France", Date.valueOf("1986-09-01"), 10)));
        logger.info("Inserting Player: {}", repo.insertPlayer(new Player2("Thiem", "Austria", Date.valueOf("1993-09-03"), 17)));
